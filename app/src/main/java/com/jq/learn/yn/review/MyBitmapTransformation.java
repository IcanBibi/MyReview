...
import com.bumptech.glide.load.resource.bitmap.BitmapTransformation;
 ...
 class MyBitmapTransformation extends BitmapTransformation {
    ...
    protected Bitmap transform(BitmapPool pool, Bitmap toTransform, int outWidth, int outHeight) {
        ...
        int radius = min / 2;
        RadialGradient radialGradient = new RadialGradient(toTransform.getWidth() / 2 , toTransform.getHeight() / 2, radius, Color.TRANSPARENT, Color.BLUE, Shader.TileMode.CLAMP);
